...
<body>
	...
	<form action="" method="post">
		...
		<input type="text" name="purse" value="B956112978613" />
		<br/>
		...
		<input type="text" name="datestart" value="20100116 00:00:00" />
		<br/>

		<label>максимальное время и дата выполнения операции:</label>
		<input type="text" name="datefinish" value="20100118 00:00:00" />
		<br/>
