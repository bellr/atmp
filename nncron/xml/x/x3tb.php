...
<body>
	...
	<form action="" method="post">
		...
		<input type="text" name="purse" value="<?=$wmb;?>" />
		<br/>
		...
		<input type="text" name="datestart" value="20110701 00:00:00" />
		<br/>

		<label>максимальное время и дата выполнения операции:</label>
		<input type="text" name="datefinish" value="20110801 00:00:00" />
		<br/>
Разбивать с (пример) 20110701 00:00:00 по 20110715 00:00:00 и с 20110715 00:00:00 по 20110801 00:00:00<br />
...
echo "<br />Всего распространено на сумму: {$s}";
?>
